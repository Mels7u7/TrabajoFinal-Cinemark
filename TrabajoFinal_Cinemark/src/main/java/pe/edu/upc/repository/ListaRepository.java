...
public interface ListaRepository extends JpaRepository<Lista_Compra, Integer> {
	...
	@Query("select l from Lista_Compra l where l.proveedorLista.nombreProveedor like %?1%")
	public List<Lista_Compra> findLista_CompraBynombreProveedor(String nombreProveedor);
